...
const int VALVULA2 = 3;
const int VALVULA3 = 2;
...
void enviarDatos(){                                                       // Funcion que usara el hilo para recibir los comandos
  ...
  String linea = LIMIT + estadoTrig + LIMIT + estadoEco + LIMIT + estadoBomba + LIMIT + estadoValvula1 +
    LIMIT + estadoValvula2 + LIMIT + estadoValvula3 + LIMIT + estadoModoManual + SEPARADOR;                // En la variable linea queda la informacion de los estados de los pines, donde cada uno puede ser ON o OFF y estan separados por comas
  bluetooth.println("     ");
